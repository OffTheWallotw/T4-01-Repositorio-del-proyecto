const MenusModel = require("../models/MenuModels");
...
class MenusController
{
    ...
    static async indexPost(req, res) {
        try {
            ...
            const insertedId = await MenusModel.insertar(newData);
    ...
    static async itemPut(req, res) {
        try {
            ...
            const result = await MenusModel.reemplazar(id, updatedData);
    ...
    static async itemPatch(req, res) {
        try {
            ...
            const result = await MenusModel.actualizar(id, updatedFields);
